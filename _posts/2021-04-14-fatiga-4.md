...
$$\sigma_t = \sigma_W · \frac{5}{3 – 2 \dot \kappa} \leq 0,66 · \sigma_E \tag*{(1)}$$
...
class Formulae(DataFrame):
    ...
    def __init__(self, df, sigma_E, sigma_R):
        ...
        for fatigue in case of ratio k ≤ 0 and k > 0 for tension and 
        compression.
...
- Caso de $$\kappa$$ igual o menor de 0 (negativo) y tensión de tracción.
    ...
    $$\kappa \leq 0 \text{ para tracción: } \sigma_t = \sigma_W · \frac{5}{3 – 2 \dot \kappa} \leq 0,66 · \sigma_E$$
...
```
    ...
    Las tensione $$\sigma_0$$ y $$\sigma_{+1}$$ están definidas en los siguientes métodos de la clase:
...
$$\sigma_t = \frac{\sigma_O}{1 - \left(1 - \dfrac{\sigma_O}{\sigma_{+1}}\right) · \kappa} =\frac{74,7}{1 - \left(1 - \dfrac{74,7}{367,5}\right) \cdot 0,454} = 
...
$$\sigma_t = \sigma_W \frac{5}{3 – 2 \cdot \kappa} = 33,3 \frac{5}{3 - 2 · (-0,873)} = $$
