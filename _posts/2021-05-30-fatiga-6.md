...
$$\frac{\sigma_{x,max}}{\sigma_{xa} = \frac{-130}{-140,4} = 0,93$$

$$\frac{\sigma_{y,max}}{\sigma_{ya} = \frac{-1}{-90,0} = 0,01$$
...
$$\frac{\sigma_{x,max}}{\sigma_{xa} = \frac{-79}{-35,6} = 2,22$$

$$\frac{\sigma_{y,max}}{\sigma_{ya} = \frac{-1}{-90,0} = 0,01$$

$$\frac{\tau_{xy,max}}{\tau_{a} = \frac{-6}{91} = -0,07$$
...
$$\sqr{\left(\frac{-79}{-35,6}\right)^2 + \left(\frac{-1}{-66,6}\right)^2 - \frac{(-79) \cdot (-1)}{|-35,6| \cdot |-66,6|} + \left(\frac{-6}{91,0}\right)^2} = 2,21$$
